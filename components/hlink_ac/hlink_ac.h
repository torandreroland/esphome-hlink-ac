...
static const char *const ESPHOME_FAN_QUIET = "Quiet";
static const char *const ESPHOME_FAN_LOW = "Low";
static const char *const ESPHOME_FAN_MEDIUM = "Medium";
static const char *const ESPHOME_FAN_HIGH = "High";
